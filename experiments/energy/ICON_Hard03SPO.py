...
logging.basicConfig(filename='SPO_hard03.log', level=logging.INFO,format=formatter)
logging.info('Started\n')

file = "../../EnergyCost/Hard_Instances/instance03/instance.txt"
filename = "../Results/Hard03_SPO_timelimit.csv"
modelPATH = str('../Results/Hard03/SPO_hard03')
