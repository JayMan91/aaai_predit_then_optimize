...
logging.basicConfig(filename='SPO_hard04.log', level=logging.INFO,format=formatter)
logging.info('Started\n')

file = "../../EnergyCost/Hard_Instances/instance04/instance.txt"
filename = "../Results/Hard04_SPO_timelimit.csv"
modelPATH = str('../Results/Hard04/SPO_hard04')
