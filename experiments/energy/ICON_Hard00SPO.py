...
logging.basicConfig(filename='SPO_hard00.log', level=logging.INFO,format=formatter)
logging.info('Started\n')

file = "../../EnergyCost/Hard_Instances/instance00/instance.txt"
filename = "../Results/Hard00_SPO_timelimit.csv"
modelPATH = str('../Results/Hard00/SPO_hard00')
...
warmstart_hyperparams = {#'baseline': {'reset':True,'presolve':False,'warmstart':False},
        'prestart':{'reset':False,'presolve':True,'warmstart':False},'prebest':{'reset':False,'presolve':True,'warmstart':True},
