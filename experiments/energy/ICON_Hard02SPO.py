...
logging.basicConfig(filename='SPO_hard02.log', level=logging.INFO,format=formatter)
logging.info('Started\n')

file = "../../EnergyCost/Hard_Instances/instance02/instance.txt"
filename = "../Results/Hard02_SPO_timelimit.csv"
modelPATH = str('../Results/Hard02/SPO_hard02')
