...
logging.basicConfig(filename='QPTL_Load12.log', level=logging.INFO,format=formatter)
logging.info('Started\n')



file = "../../EnergyCost/load2/day01.txt"
filename= "../Results/Load2_qptl.csv"
...
n_iter= 12
H_combinations=[ {'optimizer':optim.Adam,'lr':1e-3,'betas':(0.95, 0.8)},
...
for i in range(n_iter):
	for h in H_combinations:
		...
		start =  time.time()
		clf  =  qptl_ICON(epochs=10,param= param_data,verbose=True,validation=True,validation_relax=True,  **h )
